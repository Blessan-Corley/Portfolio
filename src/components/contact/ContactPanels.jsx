...
export const QuickConnectPanel = ({ contactInfo, copiedKey, onCopy }) => (
  <motion.div
    className="space-y-4"
  ...
  >
    ...
    <div className="space-y-3">
      ...
      <motion.button
        ...
        style={panelStyle}
        whileHover={hoverCard}
        onClick={() => onCopy(contactInfo.phone, 'phone')}
        whileTap={{ scale: 0.99 }}
      >
...
export const LocationPanel = ({ contactInfo }) => (
  <motion.div
    className="space-y-4"
...
export const StatusPanel = ({ contactInfo }) => (
  <motion.div
    className="space-y-4"
    initial={{ opacity: 0, x: 20 }}
    whileInView={{ opacity: 1, x: 0 }}
...
export const SocialLinksPanel = ({ contactInfo }) => (
  <motion.div
    className="space-y-4"
    initial={{ opacity: 0, x: -20 }}
    whileInView={{ opacity: 1, x: 0 }}
...
export const ResourcesPanel = ({ portfolioUrl, onResumeDownload }) => (
  <motion.div
    className="space-y-4"
    initial={{ opacity: 0, y: 20 }}
    whileInView={{ opacity: 1, y: 0 }}
...
export const LetsTalkPanel = ({ email }) => (
  <motion.div
    className="space-y-4"
    initial={{ opacity: 0, x: 20 }}
    whileInView={{ opacity: 1, x: 0 }}
